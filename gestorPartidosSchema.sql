...
CREATE TABLE partido(id_partido SERIAL PRIMARY KEY, equipo1 VARCHAR(50) REFERENCES equipo, equipo2 VARCHAR(50) REFERENCES equipo, equipo_ganador VARCHAR(50) REFERENCES equipo, equipo1_goles integer DEFAULT 0 NOT NULL, equipo2_goles integer DEFAULT 0 NOT NULL);
