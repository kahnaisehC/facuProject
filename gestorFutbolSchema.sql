...
COPY public.partido (id_partido, fecha_hora, equipo1, equipo2, dni_arbitro, id_torneo, id_partido_torneo, equipo1_goles, equipo2_goles, resultado) FROM stdin;
\.
...
--
-- Name: partido partido_dni_arbitro_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.partido
    ADD CONSTRAINT partido_dni_arbitro_fkey FOREIGN KEY (dni_arbitro) REFERENCES public.arbitro(dni);
